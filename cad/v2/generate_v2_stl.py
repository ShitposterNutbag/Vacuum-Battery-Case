#!/usr/bin/env python3
"""Generate coarse V2 STL exports when OpenSCAD is unavailable.

The mesh is a faceted approximation of the OpenSCAD source using box solids
with rectangular cutouts. It preserves the same envelope, cavity, split, and
functional opening dimensions documented in battery_case_v2.scad.
"""
...
def bottom():
    ...
    ux=24; uz0=floor+13.5-14/2; uz1=floor+13.5+14/2
...
def top():
    ...
    # top plate split around oversized rectangular button and LED openings
    holes=[(24-8,24+8,-12-8,-12+8),(24-12.2,24+12.2,10-3.5,10+3.5)]
...
write(out/'battery_case_v2_bottom.stl', bottom())
write(out/'battery_case_v2_top.stl', top())
